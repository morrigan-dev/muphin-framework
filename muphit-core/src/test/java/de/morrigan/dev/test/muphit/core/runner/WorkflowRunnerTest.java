...
public class WorkflowRunnerTest {
  ...
  @Before
  public void setup() {
    this.sut = new WorkflowRunner(MuphitTestSuite.class);
  }

  @Test
  public void testConstructorWithMuphitTestsClass() {
    TestClass testClass = this.sut.getTestClass();
    assertThat(testClass, is(notNullValue()));
    assertThat(testClass.getJavaClass(), is(equalTo(MuphitTestSuite.class)));

    Description description = this.sut.getDescription();
    assertThat(description, is(notNullValue()));
    assertThat(description.getDisplayName(), containsString(MuphitTestSuite.class.getName()));
  }
  ...
  public void testConstructorWithTestClassThatHasWorkflowTestAnnotation() {
    ...
    assertThat(executedTestMethod.get(0),
        is(equalTo("testTC1WorkflowABeforeSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(1),
        is(equalTo("testTC1WorkflowAAfterSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(2),
        is(equalTo("testTC1WorkflowABeforeTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(3),
        is(equalTo("testTC1WorkflowAAfterTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(4),
        is(equalTo("testTC1WorkflowABeforeTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(5),
        is(equalTo("testTC1WorkflowAAfterTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(6),
        is(equalTo("testTC1WorkflowABeforeTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)")));

    assertThat(executedTestMethod.get(7),
        is(equalTo("testTC1WorkflowAAfterTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)")));
  }
  ...
  public void testRun() {
    ...
    assertThat(worklfowABeforeSetupPhase,
        containsInAnyOrder(
            "testTC1WorkflowABeforeSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowABeforeSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowAAfterSetupPhase,
        containsInAnyOrder(
            "testTC1WorkflowAAfterSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowAAfterSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowABeforeTestPhaseA,
        containsInAnyOrder(
            "testTC1WorkflowABeforeTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowABeforeTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowAAfterTestPhaseA,
        containsInAnyOrder(
            "testTC1WorkflowAAfterTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowAAfterTestPhaseA(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowABeforeTestPhaseB,
        containsInAnyOrder(
            "testTC1WorkflowABeforeTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowABeforeTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowAAfterTestPhaseB,
        containsInAnyOrder(
            "testTC1WorkflowAAfterTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowAAfterTestPhaseB(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowABeforeTearDownPhase,
        containsInAnyOrder(
            "testTC1WorkflowABeforeTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowABeforeTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA2)"));
    ...
    assertThat(worklfowAAfterTearDownPhase,
        containsInAnyOrder(
            "testTC1WorkflowAAfterTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)",
            "testTC2WorkflowAAfterTearDownPhase(de.morrigan.dev.test.muphit.helper.TestClassA2)"));

    List<String> worklfowBBeforeSetupPhase = Arrays.asList(executedTestMethod.get(16));
    assertThat(worklfowBBeforeSetupPhase,
        containsInAnyOrder("testWorkflowBBeforeSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassB)"));
  ...
  public void testFilterBeforePhase() throws NoTestsRemainException {
    ...
    Filter filter = new Filter() {
      ...
      @Override
      public boolean shouldRun(Description description) {
        return "testTC1WorkflowABeforeSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)"
  ...
  public void testFilterAfterPhase() throws NoTestsRemainException {
    ...
    Filter filter = new Filter() {
      ...
      @Override
      public boolean shouldRun(Description description) {
        return "testTC1WorkflowAAfterSetupPhase(de.morrigan.dev.test.muphit.helper.TestClassA1)"
            .equals(description.getDisplayName());
      }
